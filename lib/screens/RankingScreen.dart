...
class CurrentRank extends StatefulWidget {
  const CurrentRank({Key? key}) : super(key: key);

  @override
  State<CurrentRank> createState() => _CurrentRankState();
}

class _CurrentRankState extends State<CurrentRank> {
  var isloader=true;
  ...
  void initState() {
    ...
    super.initState();
    //secureScreen();
    Repository().CurrentRankingFree().then(
            (value) {
          setState(() {
            isloader=false;
