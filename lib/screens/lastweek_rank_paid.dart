...
class LastWeekRankPaid extends StatefulWidget {
  const LastWeekRankPaid({Key? key}) : super(key: key);

  @override
  State<LastWeekRankPaid> createState() => _LastWeekRankPaidState();
}

class _LastWeekRankPaidState extends State<LastWeekRankPaid> {
  var isloader=true;
  ...
  void initState() {
    ...
    super.initState();
    //secureScreen();
    Repository().LastWeekRankingPaid().then(
            (value) {
          setState(() {
            isloader=false;
          });
