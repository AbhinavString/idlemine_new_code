...
import 'lastweek_rank.dart';

class GlobalRankTabs extends StatefulWidget {
  const GlobalRankTabs({Key? key}) : super(key: key);

  @override
  State<GlobalRankTabs> createState() => _GlobalRankTabsState();
}

class _GlobalRankTabsState extends State<GlobalRankTabs> {
  double Balance=00;
